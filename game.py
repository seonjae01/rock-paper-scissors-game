...
class RockPaperScissorsGame(QWidget):
    ...
    def __init__(self):
        ...
        self.rockButton.setIcon(QIcon(QPixmap('images/rock.png')))
        ...
        self.paperButton.setIcon(QIcon(QPixmap('images/paper.png')))
        ...
        self.scissorsButton.setIcon(QIcon(QPixmap('images/scissors.png')))
